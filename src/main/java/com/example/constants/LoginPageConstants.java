...
public class LoginPageConstants {
    ...
    public static final String EMAIL_REQUIRED = "//div[@text-type='email']/../div[normalize-space()='Required']"; //validate for empty input
    public static final String PASSWORD_REQUIRED = "//div[@text-type='password']/../div[normalize-space()='Required']";
    public static final String INVALID_EMAIL = "//div[@text-type='email']/../div[normalize-space()='Email not valid']"; //validate by inputting abcd
    public static final String INCORRECT_CREDS_TOASTER = "//div[@data-test-id='toaster-message']"; // assert text - Your email and/or password are incorrects
